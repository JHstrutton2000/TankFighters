...
enum WeaponLists {
    ...
    Guided   (50,  1, 0, 0,  5,  0,  0),
    MultiShot( 0,  1, 5, 2, 10, 45,  1),
    SlowShot ( 5,  1, 0, 0,  8,  0,  0),
    FastShot (100,  4, 0, 0, 20,  0,  0);
  ...
  private WeaponLists(int coolDown, int damage, int fireRate, int fireTime, float speed, int accuracy, int kick) {
